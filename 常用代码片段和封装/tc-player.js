! function (e, t) {
  ...
  return function (e) {
    ...
    for (var m = i(2), b = o(m), g = i(4), _ = o(g), w = i(1), S = (o(w), 1), E = t.FullscreenApi = {
      ...
      ], O = M[0], k = void 0, P = 0; P < M.length; P++) M[P][1] in document && (k = M[P]);
    if (k)
      for (var I = 0; I < k.length; I++) E[O[I]] = k[I];
        ...
        return a(t, e), t.prototype.render = function (t) {
          ...
          if (n) switch (i) {
            case Hls.ErrorTypes.NETWORK_ERROR:
              o.indexOf("TimeOut") > 0 ? f.console.error("鍔犺浇瑙嗛鏂囦欢瓒呮椂") : f.console.error("鏃犳硶鍔犺浇瑙嗛鏂囦欢锛岃妫€鏌ョ綉缁滐紝浠ュ強瑙嗛鏂囦欢鏄惁鍏佽璺ㄥ煙璇锋眰璁块棶锛宮3u8鏂囦欢鏄惁瀛樺湪 " + (t.response && t.response.status ? "netstatus:" + t.response.status : "")), this.notify({
                type: "error",
                code: 2,
                timeStamp: +new Date
              }), r.startLoad();
